  ...
  return {
    init: function() {
      ...
      */
      ...
      $("#advanced-wizard").bind('step_shown', function(event, data){
        if (data.currentStep === 'advanced-first') {
          progressBar
          .css('width', '33%')
          .attr('aria-valuenow', '33')
          .removeClass('progress-bar-warning progress-bar-success')
        ...
        else if (data.currentStep === 'advanced-second') {
          progressBar
          .css('width', '66%')
          .attr('aria-valuenow', '66')
          .removeClass('progress-bar-danger progress-bar-success')
        ...
        else if (data.currentStep === 'advanced-forth') {
          progressBar
          .css('width', '100%')
          .attr('aria-valuenow', '100')
          .removeClass('progress-bar-danger progress-bar-warning')
