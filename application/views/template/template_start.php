...
<head>
  ...
  <?php if ($template['theme']) { ?><link id="theme-link" rel="stylesheet" href="<?php echo ASSETS.'proui/' ?>css/themes/<?php echo $template['theme']; ?>.css"><?php } ?>
  ...
  <script src="<?php echo ASSETS;?>vendors/Chart.js/dist/Chart.min.js"></script>
</head>
<body>
